...
//     modal_container.classList.add('show3');
// });

// close.addEventListener('click', () => {
//     modal_container.classList.remove('show3');
// });
...
open8.addEventListener('click', () => {
    modal_container8.classList.add('show1');
});

close8.addEventListener('click', () => {
    modal_container8.classList.remove('show1');
});
...
open4.addEventListener('click', () => {
   modal_container4.classList.add('show3');
});

close4.addEventListener('click', () => {
    modal_container4.classList.remove('show3');
});
...
open5.addEventListener('click', () => {
     modal_container5.classList.add('show3');
});

close5.addEventListener('click', () => {
   modal_container5.classList.remove('show3');
});
...
open6.addEventListener('click', () => {
     modal_container6.classList.add('show3');
});

close6.addEventListener('click', () => {
   modal_container6.classList.remove('show3');
});